json.extract! @line, :id, :short_name, :name, :line_group_id, :created_at, :updated_at, :itinerary_link, :timetable_link
...
json.routes do
  json.array!(@line.routes) do |route|
    json.extract! route, :id, :created_at, :updated_at, :origin, :destination, :route, :route_length, :route_lonlat, :name, :short_name
  end
end
